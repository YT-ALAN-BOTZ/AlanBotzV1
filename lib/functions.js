...
const banner = cfonts.render(('Alan - BOTZ'), {
    font: 'Block',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
...
module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close , sleep}
